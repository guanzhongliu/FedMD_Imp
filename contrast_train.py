...
def parseArg():
    ...
    conf_file = os.path.abspath("conf/random_train.json")
...
if __name__ == "__main__":
    ...
    initialization_result_sim = fed_sim.init_result
    pooled_train_result_sim = fed_sim.pooled_train_result
    ...
    with open(os.path.join(save_dir_path, 'init_result.pkl'), 'wb') as f:
        pickle.dump(initialization_result_sim, f, protocol=pickle.HIGHEST_PROTOCOL)
    with open(os.path.join(save_dir_path, 'pooled_train_result.pkl'), 'wb') as f:
        pickle.dump(pooled_train_result_sim, f, protocol=pickle.HIGHEST_PROTOCOL)
    with open(os.path.join(save_dir_path, 'col_performance.pkl'), 'wb') as f:
        pickle.dump(collaboration_performance_sim, f, protocol=pickle.HIGHEST_PROTOCOL)
